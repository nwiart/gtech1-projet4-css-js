		...
		<div class="container white" id="admin-container">
			...
			<div class="section">
				...
				<?php if ($user_exists) { ?>
					...
					<div class="section">
						<a href="#modal-user-delete" class="btn waves-effect waves-light red darken-2 modal-trigger">Reactivate User</a>
					</div>
					...
					<div id="modal-user-delete" class="modal">
						...
						<div class="modal-footer">
							...
							<a href="admin-activate-user.php?login=<?php echo $_GET["login"]; ?>" class="modal-close waves-effect waves-light red darken-2 btn">Yes my boy !!!</a>
						</div>
					</div>
